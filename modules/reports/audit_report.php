<?php
// File: modules/reports/audit_report.php
...
<div class="row mb-4">
    ...
    <div class="col-md-4 text-right">
        <a href="audit_view.php?id=<?php echo $audit_id; ?>" class="btn btn-secondary">
            <i class="fas fa-arrow-left mr-2"></i>Back to Audit
        </a>
        <a href="audit_report.php?id=<?php echo $audit_id; ?>&format=pdf" class="btn btn-danger ml-2" target="_blank">
