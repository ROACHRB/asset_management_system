<?php
// File: modules/audits/view.php
include_once "../../includes/header.php";

// Check permission
if(!has_permission('conduct_audits')) {
    $_SESSION['error'] = "Access denied. You don't have permission to view audits.";
...
<div class="row mb-4">
    <div class="col-md-8">
        <h1><i class="fas fa-clipboard-check mr-2"></i>View Audit</h1>
        <p class="text-muted">
    ...
    <div class="col-md-4 text-right">
        ...
        <?php if($audit['status'] == 'completed'): ?>
            <a href="report.php?id=<?php echo $audit_id; ?>" class="btn btn-success ml-2">
            ...
            <?php endif; ?>
        <?php else: ?>
            <a href="conduct.php?id=<?php echo $audit_id; ?>" class="btn btn-primary ml-2">
